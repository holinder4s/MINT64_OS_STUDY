...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
TOTALSECTORCOUNT:   dw  1024    ; 부트 로더를 제외한 MINT64 OS 이미지의 크기(최대 1152섹터(0x90000byte)까지 가능)
...
START:
    ...
    ; 스택을 0x0000:0x0000~0x0000:0xFFFF 영역에 64KB 크기로 생성
    mov ax, 0x0000  ; 스택 세그먼트의 시작 어드레스(0x0000)를 세그먼트 레지스터 값으로 설정
...
.SCREENCLEARLOOP:               ; 화면을 지우는 루프
    ...
    cmp si, 80*25*2             ; 화면의 전체 크기는 80문자 * 25라인이고, 출력한 문자의 수를 의미하는 SI 레지스터와 비교
    jl .SCREENCLEARLOOP         ; SI 레지스터가 80*25*2보다 작다면 아직 지우지 못한 영역이 있으므로 .SCREENCLEARLOOP 레이블로 이동

    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ;   화면 상단에 시작 메시지 출력
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    push WELCOMEMESSAGE         ; 출력할 메시지의 어드레스를 스택에 삽입
    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    push OSIMAGELOADINGMESSAGE  ; 출력할 메시지의 어드레스를 스택에 삽입
...
RESETDISK:
    ...
    mov bx, 0x0000                      ; BX 레지스터에 0x0000을 설정하여 복사할 어드레스를 0x1000:0x0000(0x10000)으로 최종 설정
...
READEND:
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ;   OS 이미지 로딩이 완료되었다는 메시지를 출력
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    push OSIMAGELOADINGCOMPLETEMESSAGE  ; 출력할 메시지의 어드레스를 스택에 삽입
    push 1                              ; 화면 Y 좌표(1)를 스택에 삽입
...
PRINTMESSAGE:
    ...
    mul si                      ; AX 레지스와 SI 레지스터를 곱하여 화면 X 어드레스 계산
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;   부트로더 시작 메시지
WELCOMEMESSAGE:   db 'MINT64 OS Boot Loader Start~!!', 0      ; 출력할 메시지 정의(마지막은 0으로 설정하여 .MESSAGELOOP에서 문자열이 종료되었음을 알 수 있도록 함)

DISKERRORMESSAGE:               db  'DISK Error~!!', 0
OSIMAGELOADINGMESSAGE           db  'OS Image Loading...', 0
OSIMAGELOADINGCOMPLETEMESSAGE   db  'Complete~!!', 0
...
times 510 - ( $ - $$ )  db  0x00    ; $: 현재 라인의 어드레스
                                    ...
                                    ; time: 반복 수행
                                    ; 현재 위치에서 어드레스 510Rkwl 0x00으로 채움
